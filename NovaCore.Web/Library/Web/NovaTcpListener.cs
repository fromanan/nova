...
/// </summary>
public class NovaTcpListener : TcpListener
{
    /// <summary>
    ...
    public NovaTcpListener(IPEndPoint localEP) : base(localEP)
    {
    }
    ...
    public NovaTcpListener(IPAddress localaddr, int port) : base(localaddr, port)
    {
    }
