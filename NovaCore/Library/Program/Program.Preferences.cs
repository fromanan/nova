...
internal partial class Program
{
    ...
    public sealed class Preferences : ConfigFile
    {
        ...
        public override string GetFilepath() => Path.Combine(Paths.Preferences, "preferences.json");
            
        [JsonProperty("index")]
        private Dictionary<string, PrefType> Index = new();
            
        [JsonProperty("strings")]
        private Dictionary<string, string> StringEntries = new();
            
        [JsonProperty("floats")]
        private Dictionary<string, float> FloatEntries = new();
            
        [JsonProperty("ints")]
        private Dictionary<string, int> IntEntries = new();
